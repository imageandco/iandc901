...
// Handles animations, interactions, form functionality, and expandable service menu
...
// Service Menu - Expandable Categories
    ...
    categoryHeaders.forEach(header => {
        header.addEventListener('click', () => {
            ...
            if (content.classList.contains('active')) {
                anime({
                    targets: content,
                    maxHeight: [0, content.scrollHeight + 'px'],
                    opacity: [0, 1],
                    duration: 400,
                    easing: 'easeOutQuad'
                });
...
function showFieldError(input, message) {
    ...
    // Add error styling
    input.style.borderColor = '#4C04CD';
    input.style.boxShadow = '0 0 0 3px rgba(76, 4, 205, 0.1)';
...
function initMobileMenu() {
    ...
    hamburger.addEventListener('click', () => {
        ...
        if (hamburger.classList.contains('active')) {
            ...
            navLinks.style.boxShadow = '0 10px 30px rgba(52, 4, 23, 0.1)';
            navLinks.style.animation = 'slideDown 0.3s ease';
            navLinks.style.borderTop = '2px solid #340417';
        } else {
            hamburger.children[0].style.transform = 'none';
            hamburger.children[1].style.opacity = '1';
            hamburger.children[2].style.transform = 'none';
...
function initParallaxEffect() {
    ...
    function updateParallax() {
        const scrolled = window.pageYOffset;
        const rate = scrolled * -0.2; // Very subtle parallax effect
